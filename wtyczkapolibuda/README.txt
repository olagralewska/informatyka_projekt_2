...
What's Next:
  ...
  * Customize it by editing the implementation file: ``WtyczkaPolibuda.py``

  * Create your own custom icon, replacing the default icon.png

  * Modify your user interface by opening WtyczkaNaZajeciah_dialog_base.ui in Qt Designer
